...
int main(void)
{
    ...
    //     cout << "position : " ;
    //     for(pair<int,int>p : i.positions)
    //     {
    ...
    // {
    //     cout << "connect : " << bridge.connects[0].first << "," << bridge.connects[0].second;
    //     cout << "  " << bridge.connects[1].first << "," << bridge.connects[1].second << endl;
    //     cout << "length : " << bridge.length << endl;
    //     cout << "path : ";
    //     for(pair<int,int> p : bridge.path)
    //     {
    //         cout << p.first << "," << p.second << "  ";
    //     }
    //     cout << endl << endl;
